...
#     if not request.json:
#         return jsonify({'error': 'Missingyu JSON in request body'}), 400
...
# @serverApp.route('/temperature/now/chunk/v2', methods=['POST'])
# # @jwt_required()
# def getTemperatureChunk1():
#     data = request.get_json()
#     pprint(data)
#     lat = data['lat']
#     long = data['long']
